...
if __name__ == '__main__':
    ...
    parser.add_argument("-q", "--sampling_rate", help="number of co-working process", type=float, default=1.0)
    ...
    parser.add_argument("-o", "--output_dir_path", help="directory where processed data saved", type=str, default='./dataset/processed_zinc_smiles/data_l')
